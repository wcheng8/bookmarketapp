...
class RecommendationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post recommendations_url, params: { recommendation: { author: @recommendation.author, book: @recommendation.book, context: @recommendation.context, title: @recommendation.title } }
    end
  ...
  test "should update recommendation" do
    patch recommendation_url(@recommendation), params: { recommendation: { author: @recommendation.author, book: @recommendation.book, context: @recommendation.context, title: @recommendation.title } }
